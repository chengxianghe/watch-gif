...
@property (nonatomic, strong) RCTRefreshControl *myRefreshControl;
...
- (void)dockClosestSectionHeader
{
  ...
  if (self.myRefreshControl != nil && self.myRefreshControl.refreshing) {
    scrollTop -= self.myRefreshControl.frame.size.height;
  }
...
- (void)setMyRefreshControl:(RCTRefreshControl *)myRefreshControl
{
  if (_myRefreshControl) {
...
- (void)insertReactSubview:(UIView *)view atIndex:(__unused NSInteger)atIndex
{
  if ([view isKindOfClass:[RCTRefreshControl class]]) {
    _scrollView.myRefreshControl = (RCTRefreshControl*)view;
  } else {
...
- (void)removeReactSubview:(UIView *)subview
{
  if ([subview isKindOfClass:[RCTRefreshControl class]]) {
    _scrollView.myRefreshControl = nil;
  } else {
...
{
  if (_contentView && _scrollView.myRefreshControl) {
    return @[_contentView, _scrollView.myRefreshControl];
  }
...
- (void)layoutSubviews
{
  ...
  RCTRefreshControl *refreshControl = _scrollView.myRefreshControl;
